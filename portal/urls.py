...
urlpatterns = [
    ...
    path("reports/customer-list/", views.customer_list_report_view, name="customer_list_report"),
    path("reports/customer-list/pdf/", views.customer_list_report_pdf_view, name="customer_list_report_pdf"),
